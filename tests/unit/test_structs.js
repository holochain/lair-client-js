...
function structs_tests () {
  it("should encode/decode wire type 'Unlock Passphrase Response (4278190097)'", async () => {
    ...
    expect(bytes.toHex()).to.equal(
      compress(
        '21 00 00 00 11 00 00 ff 01 00 00 00 00 00 00 00 09 00 00 00 00 00 00 00 50 61 73 73 77 30 72 64 21'
      )
    )
    ...
    expect(() => {
      ...
      'does not have enough bytes to get LairString size',
      ConversionError
    )
  ...
  it("should encode/decode wire type 'Get Server Info Response (49)'", async () => {
    ...
    expect(bytes.toHex()).to.equal(
      compress(
        '4c000000310000000100000000000000 1f00000000000000 4c616972204b657973746f7265202d205369676e696e672053657276696365 0d00000000000000 76302e312e302d636f6f6c696f'
      )
    )
  ...
  it("should encode/decode wire type 'TLS Create Cert Response (273)'", async () => {
    ...
    let cert_sni = Buffer.from(
      '7ec915391bc1491bd52047621d27b097aa352d546e542b',
      'hex'
    )
    let digest = Buffer.from(
      'ba8904a3233dbd91ccd15eb63e2c93264063b950ac9d3d58d2e0b0b5c28a7105',
      'hex'
    )
    ...
    expect(bytes.toHex()).to.equal(
      compress(
        '53000000110100000100000000000000 0d000000 1700000000000000 7ec915391bc1491bd52047621d27b097aa352d546e542b ba8904a3233dbd91ccd15eb63e2c93264063b950ac9d3d58d2e0b0b5c28a7105'
      )
    )
  ...
  it("should encode/decode wire type 'Sign by Public Key Request (576)'", async () => {
    let pub_key = Buffer.from(
      '3ffae1d875986b6bbac03eb277eee505fc36ca3022968f66fb412c4b477dc51c',
      'hex'
    )
    let message = Buffer.from(
      compress(
        '05 54 89 8a 56 b4 ff 4e 83 be 46 5c d6 4d 0f c9 12 79 04 a0 5a aa e7 b6 45 cb fc c1 91 3b 1c d3 87 75 2b 48 24 11 4b c1'
      ),
      'hex'
    )
    ...
    expect(bytes.toHex()).to.equal(
      compress(
        '60000000400200000100000000000000 3ffae1d875986b6bbac03eb277eee505fc36ca3022968f66fb412c4b477dc51c 2800000000000000 0554898a56b4ff4e83be465cd64d0fc9127904a05aaae7b645cbfcc1913b1cd387752b4824114bc1'
      )
    )
    ...
    expect(struct[1].toHex()).to.equal(
      '2800000000000000' + message.toString('hex')
    )
    ...
    expect(() => {
      ...
      'Cannot push another item onto Ed25519SignByPublicKeyRequest',
      Error
    )
  })
  ...
  it("should encode/decode wire type 'Sign by Public Key Response (577)'", async () => {
    let signature = Buffer.from(
      'ea067251189fa64a65a33548dc8c4e2989b50d27ec915391bc1491bd52047621d27b097aa352d5470baa9356260cda206d77da5c13d32ab8465f2265bccd7970',
      'hex'
    )
    ...
    expect(bytes.toHex()).to.equal(
      compress(
        '50000000410200000100000000000000 ea067251189fa64a65a33548dc8c4e2989b50d27ec915391bc1491bd52047621d27b097aa352d5470baa9356260cda206d77da5c13d32ab8465f2265bccd7970'
      )
    )
