...
const full_msg =
  ''

const half1_msg =
  '00010000100000ff0100000000000000ae6dd17372ce0fba967ffe26ccf02cd8d7ce670028adc3c90346d4a1b2f22d7fc7e9d5ad8f4420d9e32bb3f55e89e9467f7d225427d9abca6832'
const half2_msg =
...
const half2_head =
  '0100000000000000ae6dd17372ce0fba967ffe26ccf02cd8d7ce670028adc3c90346d4a1b2f22d7fc7e9d5ad8f4420d9e32bb3f55e89e9467f7d225427d9abca6832dc581f94'
const rest_of_payload =
  ''
...
function pipe_input_to_parser (chunks, parser, interval = 10) {
  const iid = setInterval(() => {
    ...
    if (chunks.length === 0) clearInterval(iid)
  }, interval)
}
...
function parser_tests () {
  it('should forward message to another stream', async () => {
    ...
    for await (let header of parser) {
      if (header === null)
        throw new Error(
          `Parser should not get the opportunity for interval checks`
        )
