...
function types_tests () {
  it("should encode/decode type 'string'", async () => {
    ...
    expect(bytes.toHex()).to.equal(
      compress(
        '15 00 00 00 00 00 00 00 e3 81 93 e3 82 93 e3 81 ab e3 81 a1 e3 81 af e4 b8 96 e7 95 8c'
      )
    )
  ...
  it("should encode/decode type 'sized'", async () => {
    ...
    expect(bytes.toHex()).to.equal(
      compress('0c 00 00 00 00 00 00 00 48 65 6c 6c 6f 20 57 6f 72 6c 64 21')
    )
